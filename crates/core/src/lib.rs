//! CodeScope Core — codebase indexing, search, and analysis engine.
//!
//! This crate contains all core business logic for CodeScope. It is consumed by
//! transport layers (MCP, HTTP, CLI) and the desktop GUI.
//!
//! # Modules
//!
...
//! - [`conventions`] — Convention mining from project structure
//! - [`semantic`] — BERT-based semantic code search (feature-gated)
//! - [`ast`] — Tree-sitter AST symbol extraction (feature-gated)
//! - [`graph`] — Code graph analysis (feature-gated)
